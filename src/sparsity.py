...
from data_fashion import load_fashion_mask
from data_coloured_mnist import load_coloured_mnist_mask
from data_cifar import load_cifar
...
train_fashion, test_fashion = load_fashion_mask(loss, os.environ["DATASETS"])
train_cifar, test_cifar = load_cifar(loss, os.environ["DATASETS"])
test_cifar_c = load_
